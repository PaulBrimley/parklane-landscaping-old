      ...
      <StyledSubscribe>
        ...
        <div className="body">
          <InfoBanner
            ...
            slotLeft={
              <InfoBannerLeft
                ...
                message={
                  <StyledInfoBannerMessage message="The beauty of maintaining HOA community is in the details." title="THE HOA LANDSCAPE TIPS AND INFO" titleBolded={['HOA', 'LANDSCAPE']}>
                    <div className="title">
                      <div>
          ...
          <div className="subscribe-now-action">
            <Button classes="subscribe-now-button" shadowColor="colorQuaternary" height="30px" width="150px" fontSize="1.5em" onClick={handleSubmit}>
              Subscribe Now
            </Button>
          </div>
        </div>
